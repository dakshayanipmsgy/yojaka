...
if ($mode === 'view') {
    ...
    <div class="card">
        ...
        <div class="actions" style="margin-top:10px; display:flex; gap:10px;">
            <a class="button" href="<?= YOJAKA_BASE_URL; ?>/app.php?page=print_document&amp;type=guc&amp;id=<?= urlencode($record['id'] ?? ''); ?>" target="_blank">Print</a>
