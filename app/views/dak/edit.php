<section class="page-intro">
    <div class="panel-header">
        <h1>Edit Dak</h1>
        <a class="button" href="<?php echo yojaka_url('index.php?r=dak/view&id=' . urlencode($record['id'] ?? '')); ?>">Back to Details</a>
    </div>
    <p>Only the owner or assignee can modify this dak while it is in draft.</p>
</section>
