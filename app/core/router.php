...
function yojaka_dispatch(string $route)
{
    $controllerMap = [
        ...
        'deptadmin/branding/letterhead' => ['DeptAdminController', 'branding_letterhead'],
        ...
        'rti/list' => ['RtiController', 'list'],
        'rti/create' => ['RtiController', 'create'],
        'rti/view' => ['RtiController', 'view'],
        'rti/edit' => ['RtiController', 'edit'],
        'rti/forward' => ['RtiController', 'forward'],
        'rti/return' => ['RtiController', 'return_action'],
        'rti/close' => ['RtiController', 'close'],
        'rti/reply' => ['RtiController', 'reply'],
        ...
        'letters/pdf' => ['LettersController', 'pdf'],
